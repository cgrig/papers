...
results are presented in \R{Chapter 16}.
...
An agent is an instance of an agent design. This was explained on page 66 (now \R{103}): the relationship between an agent design and an agent in AF-Raf is similar to that between a class and an object in Java.
