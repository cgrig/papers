...
text that presents informal high level ideas, more formal examples have their own
environment, and large, significant examples have their own figure.
...
\todo{Revisit if there is enough time.}
...
not clear, and the third objective of the thesis should be better analyzed in
the thesis.
...
\end{them}
This sentence refered only to the fact that the received messages have to be
removed explicitly from the belief base. Since it caused confusion, I have
removed it.
...
\end{them}
I disagree. A selection function is unnecessary for generality, and is ugly.
For an explanation why implicit nondeterminism is good see:
http://homepages.inf.ed.ac.uk/gdp/publications/Dijkstras_Predicate_Transformers.pdf
...
and Haskell. None of those programming languages have semantincs for this
features.
