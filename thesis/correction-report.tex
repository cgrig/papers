...
checking is useful. The types of messages are being described in the same chapter in section 11.3.2 (page ).
...
\end{them}
Non-ground terms are terms that may contain variables. In AF-Raf beliefs are
ground terms, while messages and queries are non-ground terms. The examiner is
refered to the section 7.0.7 on Multi-Sorted Predicate logic for a definition
...
\end{them}
The canditate's solution is presented in the first sentence of that paragraph:
