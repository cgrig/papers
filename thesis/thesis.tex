...
technologies. JaCaMo~\cite{}, a Multi-Agent Programming framework, combines
...
programming paradigm, the multi agent programming that incorporates all the
...
Recently the were developed a number of normative organisation frameworks
some of them incorporate programming languages for norm-aware agents and
normative organisation. Notable are N-2APL and 2OPL.

The N-2APL~\cite{Coordination, Organizations, Institutions, and Norms in Agent
Systems IX} agent oriented programming language is based on the 2-APL
