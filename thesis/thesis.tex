...
system. A \emph{transition system} is an (typically infinite) directed
...
\end{itemize}
The complete state of an AF-Raf program is rather larger. It is therefore
...
+!announce_result(CNPId,[offer(O,LAg)|T],WAg)
  ...
  !announce_result(CNPId,T,WAg).
\end{verbatim}
\caption{Contract Net Initiator Jason}
\label{fig:jasonIn}
\end{figure} % >>>
