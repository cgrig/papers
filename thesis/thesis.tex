...
\emph{%
  ...
  Informally,
    AF-Raf sessions are inspired by global types,
    and AF-Raf roles are inspired by local types.
  But, the AF-Raf formalism is new, and distinct from that of session types.
}

TODO: origrinal mast has many more subtelties, which we ignored on purpose

TODO: methodology for development with original mast
