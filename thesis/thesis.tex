...
qualified id which represents a file name and its extension.
...
\begin{verbatim}
pred_op returns [String v]: (a=eq_op | a=cmp_op);
eq_op returns [String v]: (a='==' | a='!=');
cmp_op returns [String v]: (a='<' | a='>');
add_op returns [String v]: (a='+' | a='-');
mul_op returns [String v]: (a='*' | a='/' | a='%');
unary_op returns [String v]: (a='!' | a='-');
...
\begin{verbatim}
assignment returns [IPlanStep v]: 
  a=LID '=' (b=function | b=list_comprehension);

\end{verbatim}

\begin{verbatim}
while_statement returns [IPlanStep v]: 
  'while' a=formula '{' b=statement '}';

\end{verbatim}

\begin{verbatim}
foreach returns [IPlanStep v]: 
  'foreach' a=formula '{' b=statement '}';

\end{verbatim}

\begin{verbatim}
update_belief returns [IPlanStep v]: 
  (a='+' | a='-') b=predicate;
...
\begin{verbatim}
list_comprehension returns [ITerm v]: 
  '[' term '|' formula ']';
