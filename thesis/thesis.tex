...
Agent0 is a prototype programming language, and it includes only
constructs related to the agent level of a multiagent system. Shoham only
...
The AgentSpeak interpreter relies on three selection functions. First, the event
selection selects a single event from the set of events. Second, the option
function selects a plan from the set of applicable plans. Third, the
...
beliefs, testing beliefs and goals, managing dynamics of goals,
external actions and communication actions.
