...
Each {\it Rule\/} has a query\slash condition and a body, which is usually a
composed statement; optionally, just to aid debugging, it may also have
...
{\it IFormula\/} and {\it IPlanStep\/} are interfaces reused from the
