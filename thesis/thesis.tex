...
This chapter tries to answer the following research question: \textit{Is the
readability and usability of an agent oriented programming language
improved by the addition of the role and session programming constructs as
well as by the algebraic data types and the type checking functionality?} In
order to answer this twofold research question the implementation of a FIPA
interaction protocol is analysed in a case study.
