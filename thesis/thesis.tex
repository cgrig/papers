...
The background for objective (1a) is presented in ()
...
The background for (2a) was presented in (\autoref{})
Objective (2a) was addressed in (\autoref{sec:roles})
Objective (2a) was  evaluated in (\autoref{})
...
The channels themselves are \emph{values}:
  they can be created,
  and they can themselves be communicated over (other) channels.
