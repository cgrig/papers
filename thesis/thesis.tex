...
architecture as well as by the reactive planning theory. The Belief,
Desire, Intention agent architecture, based on the human practical
...
The reactive planning represents a group
...
AgentSpeak, based on speech acts, MetateM, based on temporal logic, 3APL,
based on practical reasoning rules, Jason, which extends AgentSpeak with
communication, and GOAL, based on declarative goals.
