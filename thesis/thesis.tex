...
GOAL is a rule-based programming language, its focus is on agent
reasoning. GOAL agents consists of four components: a belief base, a goal base,
action rules, and action specifications. The beliefs and goals constitute
agent's mental state. \cite{} GOAL Agents Instantiate Intention Logic
% >>>
