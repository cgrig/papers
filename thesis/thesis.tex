...
Agent Oriented Programming is based on the anthropomorphic metaphor, namely
it attributes human characteristics and behaviour to a software program.
This idea grew within Artificial Intelligence research which focused on
developing computational models for human thinking. Distributed Artificial
Intelligence adds communication and interaction to the studied processes.
Within Distributed Artificial Intelligence appeared the actor models as a
way of performing concurrent computation based on message passing. Based on
this appeared the idea of open systems, which are in continuous interaction with an
...
All of the three languages presented above Jason, 2APL, and GOAL have a
belief base to model agent knowledge, goals that model the agent desires,
some sort of plans or strategies for achieving agent's goals, actions that
...
in the environment. However none of them incorporate any social concept to
organise agent interaction. 
...
This chapter provides an explanation of the related concepts that
