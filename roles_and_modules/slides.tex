...
\uncover<2>{\node[anchor=north west,red] at (u.south west) {$f(\mathit{Times}(\mathit{Plus}(\mathit{Ct}(2),\mathit{Ct}(3)), \mathit{Ct}(4)))$};}
\uncover<3>{\node[anchor=north,red] at (u.south) {$f((2+3)\times4)$};}
\uncover<4->{\node[anchor=north] at (u.south) {$f((2+3)\times4)$};}
\uncover<4>{\draw[msg] (u) -- node[below]{$f(\mathrm{call}(\mathit{num}), (2+3)\times4$)} (c);}
