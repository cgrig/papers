...
Agent-oriented programming research
...
I'm not sure what is the right form.}
 ...
 We used a particular language for concreteness. We chose
2APL because it has formal semantics~\cite{} and is therefore easy to
understand, and because Dastani et al.~\cite{} suggested (in the context of
2APL) that 
