...
structure, functionality and norms. S-Moise+
\cite{DBLP:conf/atal/HubnerSB05} is an organisational middleware
implementing the Moise+ methodology, which looks promising, but proves very hard to use. 

AGR model Aalaadin, Madkit
