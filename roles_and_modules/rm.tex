...
We think that integrating the organisation layer to the agent
oriented programming languages will simplify the development process of
MAS. In pursuing this 
